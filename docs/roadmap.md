...
| M4 — Enforced gate | **Spec 0005 Verified** (2026-09-20); milestone gate review pending | Verified (0005): CLI (`gate`, `publish-check`, `policy-approve`), 41-case adversarial corpus with the never-allow discipline machine-checked, `./scripts/check` green (214 tests, 2154 assertions); next is the M4 milestone gate review against the design's M4 gate conditions |
